...
<head>
    ...
    <style>
        ...
        .contact-card p { margin: 10px 0; font-size: 1.1rem; font-weight: 600; }
        .contact-card a { color: #2980b9; text-decoration: none; font-weight: bold; }
...
<body>
    ...
    <section class="container" id="gallery">
        ...
        <div class="grid">
            <div class="image-box" onclick="openLightbox('1.jpeg')"><img src="1.jpeg" alt="Image 1"></div>
            <div class="image-box" onclick="openLightbox('2.jpeg')"><img src="2.jpeg" alt="Image 2"></div>
            <div class="image-box" onclick="openLightbox('3.jpeg')"><img src="3.jpeg" alt="Image 3"></div>
            <div class="image-box" onclick="openLightbox('4.jpeg')"><img src="4.jpeg" alt="Image 4"></div>
            <div class="image-box" onclick="openLightbox('5.jpeg')"><img src="5.jpeg" alt="Image 5"></div>
            <div class="image-box" onclick="openLightbox('6.jpeg')"><img src="6.jpeg" alt="Image 6"></div>
            <div class="image-box" onclick="openLightbox('7.jpeg')"><img src="7.jpeg" alt="Image 7"></div>
            <div class="image-box" onclick="openLightbox('89.jpeg')"><img src="89.jpeg" alt="Image 8"></div>
        </div>
    </section>
